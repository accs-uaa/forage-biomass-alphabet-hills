...
google_folder = '1QzbzztxgaotR3Z5xKQ-eTbCWPltbDTpK'
...
# Set data folder
data_folder = os.path.join(drive, root_folder, 'Projects/WildlifeEcology/Moose_AlphabetHills/Data/Data_Input/imagery/sentinel-2/unprocessed')
