# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Download burn difference from Drive
# Author: Timm Nawrocki
# Last Updated: 2022-03-29
# Usage: Must be executed in a Python 3.8 installation with Google API Python Client and PyDrive installed.
# Description: "Download burn difference from Drive" programmatically downloads burn difference (may be tiled) from a Google Drive folder. Burn difference must first be calculated in Google Earth Engine and exported to the Google Drive folder.
# ---------------------------------------------------------------------------
...
google_folder = '12qCOb6uKDePLzxbPKd6JpaZnaNZoOE3g'
...
# Set data folder
data_folder = os.path.join(drive, root_folder, 'Projects/WildlifeEcology/Moose_AlphabetHills/Data/Data_Input/imagery/burn/unprocessed')
