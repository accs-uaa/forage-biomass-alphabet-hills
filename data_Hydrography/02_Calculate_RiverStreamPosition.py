...
elevation_raster = os.path.join(hydrography_folder, 'Elevation_Fill.tif')
...
river_raster = os.path.join(hydrography_folder, 'processed/River_Position.tif')
stream_raster = os.path.join(hydrography_folder, 'processed/Stream_Position.tif')

#### CALCULATE RIVER POSITION

# Create key word arguments
kwargs_river = {'position_width': 5000,
...
# Create key word arguments
kwargs_stream = {'position_width': 5000,
                 'work_geodatabase': work_geodatabase,
